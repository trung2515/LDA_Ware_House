...
@Component({
  selector: 'app-import-report-admin',
  templateUrl: './import-report-admin.component.html',
  styleUrls: ['./import-report-admin.component.css']
})
export class ImportReportAdminComponent implements OnInit {
  ...
  getData() {
    ...
    let url = 'http://office.stvg.vn:51008/api/WareHouseLDA/thongtinnhapkhov2?' + uri
    console.log(url);
