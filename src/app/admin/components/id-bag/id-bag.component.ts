...
export class IdBagComponent implements OnInit {
  ...
  getListTypePacket() {
    this.adminService.getListTypePacket().subscribe((data: any) => {
      ...
      this.listTypePacket.sort((a: any, b: any) => {
        return a.nameTypePacket
          .toLowerCase()
          .localeCompare(b.nameTypePacket.toLowerCase())
      })
  ...
  clickEditCodePacket(e: any) {
    ...
    this.objEditCodePacket.input.mvt = {
      value: this.itemCodePacketClicked.codePacket,
      isValid: true,
    }
    this.objEditCodePacket.input.tvt = {
      value: this.itemCodePacketClicked.nameProductPacket,
      isValid: true,
    }
    this.objEditCodePacket.input.dvt = {
      value: this.itemCodePacketClicked.unit,
      isValid: true,
    }
    this.objEditCodePacket.input.mt = {
      value: this.itemCodePacketClicked.description,
      isValid: true,
    }

    this.objEditCodePacket.input.lb = {
      value: this.itemCodePacketClicked.idTypePacket,
      isValid: true,
    }
    this.indexTypePacketInObjEdit = this.listTypePacket.findIndex(
      (item: any) => {
